...
function volverAInicio() {
  // Puedes redirigir a la página de inicio o realizar alguna otra acción
  // En este ejemplo, redireccionamos a la página principal (index.html)
...
function reiniciarJuego() {
  // Restablecer el estado y ocultar el botón de reinicio
